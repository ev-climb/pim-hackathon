...
insert into auth.users(id,email,raw_user_meta_data) values
  ...
  ('33333333-3333-3333-3333-333333333333','evgeny@pimpay.ru','{"full_name":"Евгений Организатор"}'),
...
reset role;
select set_config('request.jwt.claims',
  '{"sub":"33333333-3333-3333-3333-333333333333","email":"evgeny@pimpay.ru"}', false);
set role authenticated;
